...
export default function BarraFundo({ titulo, children }: BarraFundoProps) {
  ...
  return (
    // O container principal muda de cor de forma suave usando transition-colors
    <div 
      className={`w-full transition-colors duration-500 ${
        isOpen ? 'bg-[#FDF1D6]' : 'bg-[#F2A900]'
      }`}
    >
    {/* Cabeçalho Clicável */}
      <button 
      ...
      >
        ...
        {/* Título */}
        <h2 className="text-[28px] md:text-[45px] font-normal text-black font-['Castoro'] leading-none">
          {titulo}
        </h2>
      </button>
